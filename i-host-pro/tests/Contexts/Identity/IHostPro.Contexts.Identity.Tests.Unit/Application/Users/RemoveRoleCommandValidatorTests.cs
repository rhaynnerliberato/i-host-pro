...
public class RemoveRoleCommandValidatorTests
{
    private static readonly RemoveRoleCommandValidator Validator = new();

    private static RemoveRoleCommand ValidCommand() => new(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), "OPERATOR");
