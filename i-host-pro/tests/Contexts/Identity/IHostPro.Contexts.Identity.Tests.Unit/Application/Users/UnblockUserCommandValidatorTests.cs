...
{
    private static readonly UnblockUserCommandValidator Validator = new();

    private static UnblockUserCommand ValidCommand() => new(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid());
