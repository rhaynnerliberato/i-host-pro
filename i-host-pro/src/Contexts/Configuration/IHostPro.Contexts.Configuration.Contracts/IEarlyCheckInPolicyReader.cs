...
/// to resolve the effective <c>EARLY_CHECKIN</c> policy — Fase 5, Incremento
...
/// schema directly.
/// </summary>
public interface IEarlyCheckInPolicyReader
{
    /// <summary>
    ...
    /// </summary>
    Task<PolicyReadResult<EarlyCheckInPolicy>> GetEffectiveAsync(
        Guid tenantId,
        Guid? propertyId,
