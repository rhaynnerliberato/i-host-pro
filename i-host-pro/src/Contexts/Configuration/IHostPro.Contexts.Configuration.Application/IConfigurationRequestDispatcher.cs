...
/// Context (Reservations, Property Management, Identity) exactly (Fase 2,
/// Checkpoint 6 homologação — Mediator <c>ISender</c> cross-context
/// ambiguity fix):
...
/// calls.
/// </summary>
public interface IConfigurationRequestDispatcher
{
