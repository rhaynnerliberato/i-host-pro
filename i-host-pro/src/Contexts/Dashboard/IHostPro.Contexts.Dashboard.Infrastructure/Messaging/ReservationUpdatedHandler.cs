...
/// <summary>Wolverine adapter for <c>ReservationUpdated</c> — see <c>ReservationCreatedHandler</c>'s own doc comment.</summary>
[NonTransactional]
public static class ReservationUpdatedHandler
{
    public static Task Handle(
        ReservationUpdated message,
