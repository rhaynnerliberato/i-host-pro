...
/// <summary>Wolverine adapter for <c>CleaningStarted</c> — see <c>CleaningCreatedHandler</c>'s own doc comment.</summary>
[NonTransactional]
public static class CleaningStartedHandler
{
    public static Task Handle(
        CleaningStarted message,
