...
/// <summary>Wolverine adapter for <c>CleaningNeedsHelp</c> — see <c>CleaningCreatedHandler</c>'s own doc comment.</summary>
[NonTransactional]
public static class CleaningNeedsHelpHandler
{
    public static Task Handle(
        CleaningNeedsHelp message,
