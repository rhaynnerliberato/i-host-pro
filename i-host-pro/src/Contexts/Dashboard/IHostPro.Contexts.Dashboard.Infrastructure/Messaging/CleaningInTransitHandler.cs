...
/// <summary>Wolverine adapter for <c>CleaningInTransit</c> — see <c>CleaningCreatedHandler</c>'s own doc comment.</summary>
[NonTransactional]
public static class CleaningInTransitHandler
{
    public static Task Handle(
        CleaningInTransit message,
