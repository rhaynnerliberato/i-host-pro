...
/// <summary>Wolverine adapter for <c>CleaningInspectionStarted</c> — see <c>CleaningCreatedHandler</c>'s own doc comment.</summary>
[NonTransactional]
public static class CleaningInspectionStartedHandler
{
    public static Task Handle(
        CleaningInspectionStarted message,
