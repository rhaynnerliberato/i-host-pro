...
/// <inheritdoc cref="MarkOwnCleaningWaitingHelpCommand"/>
public sealed class MarkOwnCleaningWaitingHelpCommandHandler : ICommandHandler<MarkOwnCleaningWaitingHelpCommand, CleaningResult>
{
    ...
    public MarkOwnCleaningWaitingHelpCommandHandler(
    ...
    public async ValueTask<Result<CleaningResult>> Handle(MarkOwnCleaningWaitingHelpCommand command, CancellationToken cancellationToken) =>
