...
/// <inheritdoc cref="MarkOwnCleaningWaitingMaterialsCommand"/>
public sealed class MarkOwnCleaningWaitingMaterialsCommandHandler : ICommandHandler<MarkOwnCleaningWaitingMaterialsCommand, CleaningResult>
{
    ...
    public MarkOwnCleaningWaitingMaterialsCommandHandler(
    ...
    public async ValueTask<Result<CleaningResult>> Handle(MarkOwnCleaningWaitingMaterialsCommand command, CancellationToken cancellationToken) =>
        await _executor.ExecuteAsync(async () =>
        {
            ...
            _eventCollector.Enqueue(new CleaningNeedsMaterial
            {
