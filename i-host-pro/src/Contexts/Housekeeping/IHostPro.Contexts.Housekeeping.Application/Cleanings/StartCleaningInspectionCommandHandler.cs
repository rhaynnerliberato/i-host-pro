...
public sealed class StartCleaningInspectionCommandHandler : ICommandHandler<StartCleaningInspectionCommand, CleaningResult>
{
    ...
    public StartCleaningInspectionCommandHandler(
    ...
    public async ValueTask<Result<CleaningResult>> Handle(StartCleaningInspectionCommand command, CancellationToken cancellationToken) =>
