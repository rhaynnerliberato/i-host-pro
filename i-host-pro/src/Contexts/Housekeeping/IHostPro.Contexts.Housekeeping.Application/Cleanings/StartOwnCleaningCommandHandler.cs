...
/// <inheritdoc cref="StartOwnCleaningCommand"/>
public sealed class StartOwnCleaningCommandHandler : ICommandHandler<StartOwnCleaningCommand, CleaningResult>
{
    ...
    public StartOwnCleaningCommandHandler(
    ...
    public async ValueTask<Result<CleaningResult>> Handle(StartOwnCleaningCommand command, CancellationToken cancellationToken) =>
