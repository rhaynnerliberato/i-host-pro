...
namespace IHostPro.Contexts.Housekeeping.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260818125715_AddWorkflowOrchestrationCommandSupport")]
    partial class AddWorkflowOrchestrationCommandSupport
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IHostPro.Contexts.Housekeeping.Domain.Cleaning", b =>
                {
                    ...
                    b.HasIndex(new[] { "TenantId", "ReservationId" }, "ix_cleanings_tenant_id_reservation_id");

                    b.HasIndex(new[] { "TenantId", "ReservationId" }, "ix_cleanings_tenant_id_reservation_id_automated_unique")
                        .IsUnique()
