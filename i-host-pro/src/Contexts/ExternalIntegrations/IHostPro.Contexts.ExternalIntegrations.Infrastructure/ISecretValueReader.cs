...
/// unrelated operations), so <see cref="SecretsManagerWhatsAppWebhookCredentialProvider"/>/
/// <see cref="SecretsManagerWhatsAppCredentialProvider"/> can be tested with
/// a small hand-rolled fake instead of a mocking library (none is used
/// anywhere in this codebase). Local to this Infrastructure project —
/// mirrors <c>MetaHttpCircuitBreakerOptions</c>'s own "deliberately NOT
/// shared between Infrastructure projects" precedent (a separate, identical
/// abstraction also exists in AIAgent.Infrastructure).
/// </summary>
