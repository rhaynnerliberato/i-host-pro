...
/// <summary>
/// Canonical, single-source claim extraction for every WhatsApp integration
/// controller action — mirrors <c>Configuration.Api.Http.ConfigurationIdentityReader</c>'s
...
/// </summary>
public static class ExternalIntegrationsIdentityReader
{
    private const string SubClaimType = "sub";
    private const string TenantIdClaimType = "tenant_id";

    public static bool TryRead(ClaimsPrincipal user, out AuthenticatedExternalIntegrationsIdentity identity)
    {
        identity = default;
        ...
        identity = new AuthenticatedExternalIntegrationsIdentity(userId, tenantId);
        return true;
    }
