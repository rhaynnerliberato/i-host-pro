...
/// <remarks>Mirrors <c>PropertyRepository</c> exactly — no explicit tenant filter needed, the ReservationsDbContext's Global Query Filter already scopes every query.</remarks>
