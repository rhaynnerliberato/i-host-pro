...
/// <remarks>Mirrors <c>UserRepository</c> exactly — no explicit tenant filter needed, the PropertyManagementDbContext's Global Query Filter already scopes every query.</remarks>
