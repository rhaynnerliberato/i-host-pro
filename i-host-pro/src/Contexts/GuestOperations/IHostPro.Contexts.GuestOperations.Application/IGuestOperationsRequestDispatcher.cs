...
/// <c>IReservationsRequestDispatcher</c>/<c>IHousekeepingRequestDispatcher</c>
...
/// in the same container (only <c>IHostPro.Api</c> does this). This
/// interface exposes only the single overload every real consumer in this
/// codebase actually calls.
/// </summary>
public interface IGuestOperationsRequestDispatcher
{
