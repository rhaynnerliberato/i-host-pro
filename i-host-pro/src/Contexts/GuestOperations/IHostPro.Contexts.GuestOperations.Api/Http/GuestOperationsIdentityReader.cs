...
/// <summary>
/// Canonical, single-source claim extraction for every Guest Operations
...
/// its own use.
/// </summary>
public static class GuestOperationsIdentityReader
{
    private const string SubClaimType = "sub";
    private const string TenantIdClaimType = "tenant_id";

    public static bool TryRead(ClaimsPrincipal user, out AuthenticatedGuestOperationsIdentity identity)
    {
        identity = default;
        ...
        identity = new AuthenticatedGuestOperationsIdentity(userId, tenantId);
        return true;
    }
